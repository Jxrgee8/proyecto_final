 ...
 */
final class Version20240221205305 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE plataforma_serie (plataforma_id INT NOT NULL, serie_id INT NOT NULL, INDEX IDX_5D498884D94388BD (serie_id), INDEX IDX_5D498884EB90E430 (plataforma_id), PRIMARY KEY(plataforma_id, serie_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
