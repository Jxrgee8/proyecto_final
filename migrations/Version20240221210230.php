 ...
 */
final class Version20240221210230 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE serie_genero (serie_id INT NOT NULL, genero_id INT NOT NULL, INDEX IDX_57AAD353D94388BD (serie_id), INDEX IDX_57AAD353BCE7B795 (genero_id), PRIMARY KEY(serie_id, genero_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE serie_plataforma (serie_id INT NOT NULL, plataforma_id INT NOT NULL, INDEX IDX_F108C01AEB90E430 (plataforma_id), INDEX IDX_F108C01AD94388BD (serie_id), PRIMARY KEY(serie_id, plataforma_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
