 ...
 */
final class Version20240311105255 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE serie (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(255) NOT NULL, fecha_lanzamiento INT NOT NULL, sinopsis VARCHAR(1800) DEFAULT NULL, poster_src VARCHAR(255) NOT NULL, fecha_creacion DATE NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE serie_lista (id VARCHAR(255) NOT NULL, serie_id INT DEFAULT NULL, lista_id INT DEFAULT NULL, fecha_agregado DATE NOT NULL, INDEX IDX_3393DA79D94388BD (serie_id), INDEX IDX_3393DA796736D68F (lista_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE temporada (id INT AUTO_INCREMENT NOT NULL, serie_id INT NOT NULL, numero_temp INT NOT NULL, fecha_creacion DATE NOT NULL, capitulos INT DEFAULT NULL, INDEX IDX_9A6BDEBDD94388BD (serie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
